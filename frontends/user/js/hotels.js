    ...
    container.innerHTML = hotels.map(hotel => `
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card h-100">
                ...
                <img src="${hotel.bilder && hotel.bilder.length > 0 ? hotel.bilder[0] : 'https://source.unsplash.com/random/300x200/?hotel'}" class="card-img-top" alt="${hotel.name}">
                <div class="card-body">
...
function showHotelDetails(hotel) {
    ...
    modalBody.innerHTML = `
        <div class="row">
            <div class="col-md-6">
                <img src="${hotel.bilder && hotel.bilder.length > 0 ? hotel.bilder[0] : 'https://source.unsplash.com/random/600x400/?hotel'}" 
